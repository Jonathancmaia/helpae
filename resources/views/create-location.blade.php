            ...
            <div class="col-12">
                <form method="post" action="{{ route('store-location') }}">
                    ...
                    <div class="input-group mt-5">
                        ...
                        <textarea id="description" name="desc" type="text" class="form-control" placeholder="O meu produto é..."
                    ...
                    <div class="input-group mt-5">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="">Valor da diária do seu produto ( R$ )</span>
                        </div>
